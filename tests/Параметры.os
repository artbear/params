...
Функция ПолучитьСписокТестов(Тестирование) Экспорт
	...
	СписокТестов.Добавить("Тест_ЧтениеПараметров_Получить");
	СписокТестов.Добавить("Тест_ЧтениеПараметров_ПолучитьСоЗначениемПоУмолчанию");
...
Процедура Тест_ЧтениеПараметров_Получить() Экспорт
	ИМЯ_НАСТРОЙКИ = "Настройки";
	ИМЯ_ПАРАМЕТРА = "Параметр";
	ЗНАЧЕНИЕ_ПАРАМЕТРА = "4";
	...
	Значение = ЧтениеПараметров.Получить(ИМЯ_ПАРАМЕТРА);
	Ожидаем.Что(Значение).Равно(ЗНАЧЕНИЕ_ПАРАМЕТРА);
КонецПроцедуры

Процедура Тест_ЧтениеПараметров_ПолучитьСоЗначениемПоУмолчанию() Экспорт
	ИМЯ_ПАРАМЕТРА = "Параметр";
	ЗНАЧЕНИЕ_ПО_УМОЛЧАНИЮ = 23;
	...
	Ожидаем.Что(Параметры).ИмеетТип("Соответствие");
	Ожидаем.Что(Параметры[ИМЯ_ПАРАМЕТРА]).Равно(Неопределено);
	
	Значение = ЧтениеПараметров.Получить(ИМЯ_ПАРАМЕТРА, ЗНАЧЕНИЕ_ПО_УМОЛЧАНИЮ);
	Ожидаем.Что(Значение).Равно(ЗНАЧЕНИЕ_ПО_УМОЛЧАНИЮ);
КонецПроцедуры
...
Процедура Тест_ЧтениеПараметровСПодстановкойИзФайла() Экспорт
	...
	СохранитьНастройкуВФайл(ПутьФайлаНастроек, СтрШаблон("{ ""spec-key"": ""%2"", 
		|""%1"": ""%%spec-key%%"",
		| ""%3"" : %4 }", 
