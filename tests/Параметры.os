...
Процедура Тест_ЧтениеПараметровИзПереданногоФайлаПоУмолчанию() Экспорт
	...
	// ВызватьИсключение "Не реализован ПОКА что";
	ПутьФайлаНастроек = МенеджерВременныхФайлов.СоздатьФайл("json");
	...
	ЧитательПараметров.УстановитьФайлПоУмолчанию(ПутьФайлаНастроек);
	
	Параметры = ЧитательПараметров.Прочитать(Парсер, ПараметрыКомСтроки, ИМЯ_НАСТРОЙКИ);
